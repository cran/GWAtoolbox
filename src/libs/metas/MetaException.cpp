...
const char* MetaException::MESSAGES[] = {
/*00*/	"Error in memory allocation.",
/*01*/	"The NULL argument was passed to the method.",
/*02*/	"The empty argument was passed to the method.",
/*03*/	"Error in memory reallocation."
};

MetaException::MetaException(int message):
	exception(), class_name(NULL), method(NULL), argument(NULL), value(NULL), message(message) {

}

MetaException::MetaException(int message, const char* class_name, const char* method, const char* argument, const char* value) :
...
MetaException::MetaException(int message, const char* class_name, const char* method, const char* argument, int value) :
	exception(), class_name(class_name), method(method), argument(argument), value(NULL), message(message) {

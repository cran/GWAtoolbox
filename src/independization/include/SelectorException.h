...
#ifndef SELECTOREXCEPTION_H_
#define SELECTOREXCEPTION_H_
...
public:
	SelectorException();
	SelectorException(int message_template_index, ... );
	SelectorException(const char* class_name, const char* method_name, int source_line);
	SelectorException(const char* class_name, const char* method_name, int source_line, int message_template_index, ... );
	SelectorException(const Exception& exception);

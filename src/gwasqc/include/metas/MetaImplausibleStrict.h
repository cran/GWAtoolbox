...
public:
	MetaImplausibleStrict(unsigned int heap_size = Meta::HEAP_SIZE) throw (MetaException);
	MetaImplausibleStrict(double less, double greater, unsigned int heap_size = Meta::HEAP_SIZE) throw (MetaException);
